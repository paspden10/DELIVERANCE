...
def table():
    ...
    sp1 = '                                         '
    sp2 = '        '
    addDir('[COLORwhite][B]'+sp1+'pl'+sp2+'w'+sp2+'d'+sp2+'l'+sp2+'f'+sp2+'a'+sp2+'pts[/B][/COLOR]','','','http://4.bp.blogspot.com/-t6TMX5293es/UJFxxgdyAtI/AAAAAAAAAAc/bp8lyCmkldo/s1600/barclays-premier-league1.png','','','','','')
...
def SKindex():
    ...
    addDir('Premier-league-table','Premier-league-table',60,'http://4.bp.blogspot.com/-t6TMX5293es/UJFxxgdyAtI/AAAAAAAAAAc/bp8lyCmkldo/s1600/barclays-premier-league1.png' ,  FANART,'','','','')
